...
func GetToken(c echo.Context) error {
	...
	if r.ClientID == "" || r.ClientSecret == "" {
		r.ClientID = conf.Conf.Box.ClientID
		r.ClientSecret = conf.Conf.Box.ClientSecret
	}
	...
	req, _ := http.NewRequestWithContext(c.Request().Context(), http.MethodPost, "https://api.box.com/oauth2/token", strings.NewReader(params.Encode()))
