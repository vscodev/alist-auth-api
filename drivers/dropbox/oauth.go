...
func GetToken(c echo.Context) error {
	...
	if r.ClientID == "" || r.ClientSecret == "" {
		r.ClientID = conf.Conf.Dropbox.ClientID
		r.ClientSecret = conf.Conf.Dropbox.ClientSecret
	}
	...
	req, _ := http.NewRequestWithContext(c.Request().Context(), http.MethodPost, "https://api.dropbox.com/oauth2/token", strings.NewReader(params.Encode()))
