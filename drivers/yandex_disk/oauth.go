...
func GetToken(c echo.Context) error {
	...
	if r.ClientID == "" || r.ClientSecret == "" {
		r.ClientID = conf.Conf.YandexDisk.ClientID
		r.ClientSecret = conf.Conf.YandexDisk.ClientSecret
	}
	...
	req, _ := http.NewRequestWithContext(c.Request().Context(), http.MethodPost, "https://oauth.yandex.com/token", strings.NewReader(params.Encode()))
