...
func GetToken(c echo.Context) error {
	...
	if r.ClientID == "" || r.ClientSecret == "" {
		r.ClientID = conf.Conf.BaiduNetdisk.ClientID
		r.ClientSecret = conf.Conf.BaiduNetdisk.ClientSecret
	}
	...
	req, _ := http.NewRequestWithContext(c.Request().Context(), http.MethodGet, "https://openapi.baidu.com/oauth/2.0/token?"+params.Encode(), nil)
